...
// The large shirts won't be available for the event due to an
// ordering issue. We need a filtered version of the runners array,
//containing only those runners with large sized shirts so they can choose a
//different size. This will be an array of objects.
...
const namesAnd = runners.map(function(currentvalue) {
  ...
  } ${currentvalue.last_name} Donated: $${currentvalue.donation}`;
});
